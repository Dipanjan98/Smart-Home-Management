...
#define BPS 8000 // transmission rate (bits per second(bps))
#define RECEIVER_ID 1 // ID of this receiver here
...
byte rawData[VW_MAX_MESSAGE_LEN]; // a buffer to store the incoming data (can contain parts of a data packets here)
